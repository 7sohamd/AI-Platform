    ...
    >
      ...
      >
        ...
        <div className="relative">
          ...
          {showModelDropdown && (
            <div className="absolute bottom-full left-0 mb-2 w-44 rounded-xl py-2 z-50" style={{ backgroundColor: 'var(--bg-tertiary)', boxShadow: '0 8px 24px rgba(0, 0, 0, 0.5)', transition: 'background-color 0.5s ease' }}>
              {models.map((model) => (
                <button
                  key={model}
                  onClick={() => {
